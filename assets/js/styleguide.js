...
$(document).ready(function() {
    ...
    // Wire the tabs from header
    $('main header li.tab').click(function() {
        $(this).siblings().removeClass('active');
        $(this).parent().parent().parent().parent().find('.tab-pane').removeClass('active');
        $(this).addClass('active');
        $(this).parent().parent().parent().parent().find('#'+this.id + '-content').addClass('active');
        
    });

    // Wire the tabs below header
...
// Wire the vertical tabs below header
    $('main li.vtabs').click(function() {
        $(this).siblings().removeClass('ui-state-active');
        $(this).parent().parent().find('.vtab-pane').removeClass('vactive');
        $(this).addClass('ui-state-active');
        $(this).parent().parent().find('#'+this.id + '-vcontent').addClass('vactive');
    });
